  ...
  return (
    <View>
      ...
      <View style={{flexDirection:'row',justifyContent:'space-around',marginTop:20}} >
        <ButtonBox image={require('../../assets/motorbike.png')} name='Go On Duty!' />

        <ButtonBox image={require('../../assets/photo.png')} name='Profile' navigation={() => {
      ...
      <View style={{flexDirection:'row',justifyContent:'space-around',marginTop:80}} >
        <ButtonBox image={require('../../assets/wallet.png')} name='MyWallet' />

      ...
      <View style={{flexDirection: 'row',marginLeft:15}}>
        <TouchableOpacity style={styles.touchButton} onPress={props.navigation}>
          <View style={styles.RestaurantBoxOutside}>
            <View style={styles.RestaurantBoxInside}></View>
          </View>
        </TouchableOpacity>
  ...
  return (
    <View style={{flex: 1}}>
      <View style={styles.containerUncentered}>
        ...
        <Restaurant
        navigation={() =>{navigation.dispatch(StackActions.replace('RestaurantPage'));}}
        ...
        <Restaurant
        navigation={() =>{navigation.dispatch(StackActions.replace(''));}}
        RestaurantName='Restaurant Name'
        FoodCategory='Italian, Spaghetti, Pasta'
        eta='30 mins'
        distance='1.5 km'
